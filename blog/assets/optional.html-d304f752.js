import{_ as t,M as p,p as e,q as o,Q as c,t as n,N as i,V as l,a1 as s}from"./framework-e799b403.js";const u={},r=s(`<h1 id="可选的其他要点" tabindex="-1"><a class="header-anchor" href="#可选的其他要点" aria-hidden="true">#</a> 可选的其他要点</h1><h2 id="getmeta-系列" tabindex="-1"><a class="header-anchor" href="#getmeta-系列" aria-hidden="true">#</a> getMeta 系列</h2><h3 id="getmeta-chip" tabindex="-1"><a class="header-anchor" href="#getmeta-chip" aria-hidden="true">#</a> getMeta_chip</h3><p>封装碎片的 meta 信息。</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">TYPE_ChipMeta</span> <span class="token punctuation">{</span>
